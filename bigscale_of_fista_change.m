...
% 调用FISTA_equal方法
[K, x_min, f_min, X, F, dF_norm] = FISTA_equal_method(ones(n,1), 1e-3,A,b,m,n);
...
% FISTA_equal 方法
function [K, x_min, f_min, X, F, dF_norm] = FISTA_equal_method(start, eps,A,b,m,n)
